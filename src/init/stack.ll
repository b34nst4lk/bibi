...
define void @plus(i32* %stack, i32** %stackptr) {
    ...
    %3 = add i32 %1, %2
    call void @push(i32** %stackptr , i32 %3)
...
entry:
    ...
    call void @push(i32** %stack_ptr, i32 10)
    call void @push(i32** %stack_ptr, i32 20)
    ...
    call void @push(i32** %stack_ptr2 , i32 2)
    call void @push(i32** %stack_ptr2 , i32 10)
    call void @plus(i32* %stack_mem2, i32** %stack_ptr2)
    call void @dump(i32** %stack_ptr2)

    call void @push(i32** %stack_ptr2 , i32 210)
    call void @push(i32** %stack_ptr2 , i32 330)

    call void @dump(i32** %stack_ptr2)
    call void @dump(i32** %stack_ptr2)

    %1 = call i32 @pop(i32** %stack_ptr2)
    %2 = call i32 @pop(i32** %stack_ptr2)
    %3 = add i32 %1, %2
    call void @push(i32** %stack_ptr2 , i32 %3)
